...
def main(argv):
    ...
    gdir = 'graphs/'
    filenames = [
        ['graphs_EPOS_Inel_0.45_sigmaInel_0.2_C_10_Csigma_3_mnlEM1.125_mnlHad999.0.root', 'h2_XmaxMaxBinVsXmaxConex_']
    ]
    ...
    for i,hs1 in enumerate(H1s):
        ...
        for j,h1 in enumerate(hs1):
            ...
            if j == 0:
                line = ROOT.TLine(0., 0., h1.GetXaxis().GetXmax(), h1.GetXaxis().GetXmax() )
            ...
            #h1.GetXaxis().SetRangeUser(200,700) h1.SetMaximum(1.35 *
            #h1.GetMaximum())
            logE = Es[j]
