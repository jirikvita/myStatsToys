...
can.cd(1)
ROOT.gPad.Print("RunCan1.pdf")

can.cd(2)
ROOT.gPad.Print("RunCan2.pdf")
can.cd(3)
ROOT.gPad.Print("RunCan3.pdf")
can.cd(4)
ROOT.gPad.Print("RunCan4.pdf")

can.cd(4)
ROOT.gPad.SetLogy(1)
ROOT.gPad.Print("RunCan4_log.pdf")

can.cd(5)
ROOT.gPad.Print("RunCan5.pdf")
