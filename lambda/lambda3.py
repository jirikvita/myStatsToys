...
def power_generator(n):
    return lambda x, count: [x * n ** i for i in range(count)]
...
print(f"{value} to the power of 2 for {count} values: {doubled_values}")
print(f"{value} to the power of 3 for {count} values: {tripled_values}")
print(f"{value} to the power of 4 for {count} values: {quadrupled_values}")
